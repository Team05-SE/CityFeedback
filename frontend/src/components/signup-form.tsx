    ...
    <form className={cn("flex flex-col gap-6", className)} {...props}>
      <FieldGroup>
        ...
        <Field>
          ...
          <Input id="name" type="text" placeholder="Jonas Dachdecker" required />
        </Field>
        <Field>
          <FieldLabel htmlFor="email">Email</FieldLabel>
          <Input id="email" type="email" placeholder="Jonas.Dachdecker@example.com" required />
          <FieldDescription>
        ...
        <Field>
          ...
          <FieldDescription>
            Das Passwort sollte unseren Test-vorgaben entsprechen.
          </FieldDescription>
        </Field>
        <Field>
        ...
        <Field>
          ...
          <FieldDescription className="px-6 text-center">
            Sie haben schon einen Account? <a href="http://localhost:5173/login#">Hier geht's zum Login!</a>
          </FieldDescription>
        </Field>
      </FieldGroup>
    </form>
